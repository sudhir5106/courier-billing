...
if($_POST['type']=="addClient")
{
	...
	try
	{	
		$res=mysql_query("INSERT INTO tbl_clients (Joining_Date, Client_Code, Client_Name, Destination_Id, Address, Contact_No, GSTIN_No, Insurance_Percent, Fuel_Surcharge, Email, Password, Branch_Id, Is_Active)
VALUES(CURDATE(), ".$_POST['client_code'].", '".$_POST['client_name']."', ".$_POST['dest_id'].", '".$_POST['address']."', ".$_POST['contact_no'].", '".$_POST['gstin'].", '".$_POST['insurance']."', '".$_POST['fuelSurcharge']."', '".$_POST['email']."', '".$_POST['password']."', ".$_SESSION['buser'].",1)");
...
if($_POST['type']=="editClient")
{
	...
	try
	{	
		$res=mysql_query("UPDATE tbl_clients SET Client_Code= '".$_POST['client_code']."', Client_Name= '".$_POST['client_name']."', Destination_Id=".$_POST['dest_id'].", Address='".$_POST['address']."', Contact_No='".$_POST['contact_no']."', GSTIN_No='".$_POST['gstin']."', Insurance_Percent=".$_POST['insurance'].", Fuel_Surcharge=".$_POST['fuelSurcharge'].", Email='".$_POST['email']."', Password= '".$_POST['password']."' WHERE Client_Id=".$_POST['client_id']);
